...
<div class="container">  
	...
	<div class="terminal">      
		<p class="prompt">-------------------------------------------------------------------------------</p>      		
		<p class="prompt">An uncaught Exception was encountered</p>      	
		<p class="prompt">Type: <?php echo get_class($exception); ?></p>
		<p class="prompt">Message: <?php echo $message; ?></p>		      			
		<p class="prompt">Filename: <?php echo $exception->getFile(); ?></p>		      			
		<p class="prompt">Line Number: <?php echo $exception->getLine(); ?></p>
		<p class="prompt">
