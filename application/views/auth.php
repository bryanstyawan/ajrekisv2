...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
		<img src="<?php echo base_url();?>assets/images/Logo-sikerja.png" id="icon" alt="User Icon" style="padding-top: 25px;padding-left: 50px;padding-bottom: 25px;"> 
    </div>

    <!-- Login Form -->
    <!-- <form> -->
      <input type="text" id="nip" name="nip" class="fadeIn second" placeholder="NIP">
