<div class="col-xs-12">
	<div class="box">
        <div class="box-header">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-2" style="padding-right: 0px;">
                        <h3 class="box-title pull-right">
                            <a href="<?php echo site_url()?>master/jabatan_fungsional_tertentu/template_master_jft/" class="btn btn-block btn-primary">Unduh Template</a>
                        </h3>                           
                    </div>                
                </div>                
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form id="upload_file" onsubmit="return validateForm()" method="post" action="<?php echo site_url()?>master/jabatan_fungsional_tertentu/import_master_jft/" enctype="multipart/form-data">
                        <div class="col-lg-12">
            ...
            <table class="table table-bordered table-striped table-view">
				...
				?>
							<tr>
								...
								<td>
									<a href="<?=base_url();?>master/jabatan_fungsional_tertentu/detail/<?=$list[$i]->id;?>" class="btn btn-warning"><i class="fa fa-edit"></i> Ubah</a>
				<?php
									if($list[$i]->counter_jft != 0)
									{
										if ($list[$i]->status == 1) {
											# code...
				?>
				...
				?>
									...
									<!-- <a href="" class="btn btn-danger"><i class="fa fa-close"></i> <?=$list[$i]->counter_jft;?></a>																		 -->
								</td>
							</tr>
				<?php
						}
...
$(document).ready(function(){
	...
	{
		window.location.href = "<?=base_url();?>master/jabatan_fungsional_tertentu/add_data";		
		// $("#newData").modal('show');
	})
