        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Form Eselon 2</h4>
                </div>
                <div class="modal-body" style="background-color: #fff!important;">
					<form id="addForm" name="addForm">
						...
						<div class="form-group">
							<div class="input-group">
			                    <span class="input-group-addon"><i class="fa fa-star"></i></span>
			                    <input type="text" id="es2" name="es2" class="form-control" placeholder="Nama Eselon 2" maxlength="100">
							</div>
						</div>
					</form>
                </div>
                ...
                <div class="modal-body" style="background-color: #fff!important;">
					<form id="editForm" name="addForm">
						...
						<div class="form-group">
							<div class="input-group">
			                    <span class="input-group-addon"><i class="fa fa-star"></i></span>
			                    <input type="text" id="nes2" name="nes2" class="form-control" maxlength="100">
...
$(document).ready(function(){
	...
	$("#add").click(function(){
		...
		{
			$.ajax({
				url :"<?php echo site_url()?>/master/data_eselon2/addEselon2",
				type:"post",
				data:"es1="+es1+"&es2="+es2,
				beforeSend:function(){
					$("#newData").modal('hide');
				...
				success:function(){
					...
					$("#isi").load('data_eselon2/ajaxEselon2');
					setTimeout(function(){
	...
	$("#edit").click(function(){
		...
		{
    		$.ajax({
    			url :"<?php echo site_url();?>/master/data_eselon2/peditEselon2",
    			type:"post",
...
function del(id){
	 Lobibox.confirm({
		 ...
		 callback: function ($this, type) {
			if (type === 'yes'){
				$.ajax({
					url :"<?php echo site_url()?>/master/data_eselon2/delEselon2/"+id,
					type:"post",
					beforeSend:function(){
						$("#loadprosess").modal('show');
					},
