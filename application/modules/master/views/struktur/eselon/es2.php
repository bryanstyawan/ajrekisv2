...
<table id="htable-view-id" class="table table-bordered table-striped">
    ...
    ?>
                <tr>
                    <td>
                        <?=$i+1;?>
                        <input type="hidden" id="oid_<?=$list[$i]['id_es2'];?>" value="<?=$list[$i]['id_es2'];?>">
                    </td>
                    <td>
                        <?=$list[$i]['nama_eselon2'];?>
                    </td>
                    <td>
                        <a class="btn btn-success" onclick="get_data('<?php echo $list[$i]['id_es2'];?>','<?=$list[$i]['nama_eselon2'];?>')"><i class="fa fa-check"></i> Pilih</a>
                    </td>
                </tr>
    <?php
            }
