...
<table id="htable-view-id" class="table table-bordered table-striped">
    ...
    ?>
                <tr>
                    <td>
                        <?=$i+1;?>
                        <input type="hidden" id="oid_<?=$list[$i]['id_es3'];?>" value="<?=$list[$i]['id_es3'];?>">
                    </td>
                    <td>
                        <?=$list[$i]['nama_eselon3'];?>
                    </td>
                    <td>
                        <a class="btn btn-success" onclick="get_data('<?php echo $list[$i]['id_es3'];?>','<?=$list[$i]['nama_eselon3'];?>')"><i class="fa fa-check"></i> Pilih</a>
                    </td>
                </tr>
    <?php
            }
...
{
    $("#f_es3").html('');    
    $("#f_es3").html('<option selected value='+arg+'>'+param+'</option>');    
    $("#f_es4").html('');    
    $("#f_atasan").html(''); 
