...
{
?>
<h2 class="text-center" style="font-variant-caps:all-small-caps;font-size:46px">Mohon untuk mengisi kuisioner kepegawaian terlebih dahulu</h2>
<div class="col-lg-12 text-center">
    <a class="btn btn-success btn-lg" href="<?php echo base_url() . '/talenta/'; ?>">KLIK DISINI</a>    
</div>
