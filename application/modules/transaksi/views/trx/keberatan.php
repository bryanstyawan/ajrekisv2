<div class="box-header with-border">
    <div class="col-lg-12 text-center">
        <h2 class="box-title" style="font-size: 38px;font-weight: 500;padding-bottom: 45px;">Pekerjaan Naik Keberatan</h2>
    </div>
</div><!-- /.box-header -->
<div class="box">
    <div class="box-body">
					...
					<?php $x=1;
						foreach($list->result() as $row){?>
							<tr>
								...
								<td></td>
								<!--
								<td><?php if($row->stat == 4){?>
									<button class="btn btn-primary btn-xs" onclick="keberatan_1('<?php echo $row->id_trx_detail;?>')"><i class="fa fa-bullhorn"></i></button>
								<?php }
								?>
								-->
						<?php $x++;}
