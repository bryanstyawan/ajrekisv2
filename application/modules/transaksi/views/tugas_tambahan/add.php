    ...
    <div class="box box-default">
        <div class="box-body">
            <div class="row">
                ...
                <div class="form-group col-md-12">
                    <label style="color: #000;font-weight: 400;font-size: 19px;">File Surat Keputusan / File Surat Keterangan Perintah / File Surat Keterangan</label><label class="pull-right">(pdf|csv|zip|docx|doc|xlsx|xl|xls|jpg|jpeg) Maxsimal 3MB</label>
