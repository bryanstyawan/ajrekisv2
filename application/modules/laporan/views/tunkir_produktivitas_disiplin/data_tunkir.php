...
$(document).ready(function(){
	...
	$("#select_eselon_1").change(function(){
		...
		$.ajax({
			url :"<?php echo site_url()?>master/data_eselon2/cariEs2_filter/filter_data_pegawai_rekap_kinerja_prod_disiplin/laporan",
			type:"post",
			...
			success:function(msg){
				...
				$.ajax({
					url :"<?php echo site_url()?>laporan/filter_data_pegawai_rekap_kinerja_prod_disiplin",
					type:"post",
	...
	$("#select_eselon_2").change(function(){
        ...
        $('#select_eselon_4').append($("<option></option>").attr("value", '').text('------------NONE------------'));
		$.ajax({
			url :"<?php echo site_url()?>master/data_eselon3/cariEs3_filter/filter_data_pegawai_rekap_kinerja_prod_disiplin/laporan",
			type:"post",
