...
//            window.location.href = "<?=base_url();?>cashflow_report/print/" + expiryDate_add + "/" + expiryDate_add1;
			if (
					txt_bulan       == "-" && 
					txt_tahun       == "-" &&
					select_eselon_1 == "-" &&
				...
				) 
			{
				...
				if (result) 
				{
					link = "<?php echo site_url()?>/laporan/export_keberatan/" + txt_bulan + "/" + txt_tahun + "/" + select_eselon_1 + "/" + select_eselon_2 + "/" + select_eselon_3 + "/" + select_eselon_4;
		            window.open(link);
...
//				        $('#example1 tbody').append(newrec);							        				   					 			    			
		    			for (var i = 0; i < msg.length; i++) {
							...
							var newrec  = '<tr id="row_'+i+'">' +
					        					...
					        					'<td>'+msg[i].kerja_disetujui+'</td>' +
					        					'<td>'+msg[i].kerja_ditolak+'</td>' +
					        					'<td>'+msg[i].kerja_revisi+'</td>' +			        									        									        									        									        									        					
					        					'<td>'+msg[i].kerja_belum_diperiksa+'</td>' +
					        					'<td>'+msg[i].jam_kerja+'</td>' +
					        					'<td>'+msg[i].menit_efektif+'</td>' +
