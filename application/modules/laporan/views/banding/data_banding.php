			...
			<table id="example1" class="table table-bordered table-striped scrolls display div1" style="overflow: auto;">
				<thead>
					<tr>
						...
						<th>Banding Ditolak</th>
						<th>Banding Disetujui</th>
					</tr>
				</thead>
				<tbody>
					<?php
					...
					?>
							  <tr>
								...
								<td><?=$list->banding;?></td>						  																																	
								<td><?=$list->banding_ditolak;?></td>						  																																	
								<td><?=$list->banding_disetujui;?></td>						  																																	
							  </tr>
				  <?php
							}
						}
...
//				        $('#example1 tbody').append(newrec);							        				   					 			    			
		    			for (var i = 0; i < msg.length; i++) {
							...
							var newrec  = '<tr id="row_'+i+'">' +
					        					...
					        					'<td>'+msg[i].banding+'</td>' +
					        					'<td>'+msg[i].banding_ditolak+'</td>' +
					        					'<td>'+msg[i].banding_disetujui+'</td>' +			        									        									        									        									        									        					
				        				   '</tr>';
					        $('#example1 tbody').append(newrec);							        				   
		    			}
		    		}
