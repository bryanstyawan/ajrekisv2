...
class Laporan extends CI_Controller {
	...
	public function rekap_survey_kinerja()
	{
		$this->Globalrules->session_rule();
		$this->Globalrules->notif_message();
		$data['title']      = 'Rekapitulasi Data Survey Kinerja';
		$data['content']    = 'laporan/kinerja/data_survey_kinerja';
		$data['bulan_list'] = $this->Globalrules->data_bulan();
		$data['list']       = '';
		$data['es1']        = $this->Allcrud->listData('mr_eselon1');
		$data['es2']        = $this->Allcrud->getData('mr_eselon2',array('id_es1'=>$this->session->userdata('sesEs1')));
	...
	public function filter_survey_kinerja()
	{
		# code...
		...
		$data['list']   = $this->Mmaster->data_pegawai('surveyKinerja','eselon2 ASC,
																eselon3 ASC,
																eselon4 ASC,
																kat_posisi ASC,
		...
		//echo "</pre>";		
		$this->load->view('laporan/kinerja/ajax_survey_kinerja',$data);
	}	
	...
	public function export_survey_kinerja_excel($es1=NULL,$es2=NULL,$es3=NULL,$es4=NULL,$bulan=NULL,$tahun=NULL)
	{
		# code...
		$es1 = ($es1 == 0) ? '' : $es1 ;		
		$es2 = ($es2 == 0) ? '' : $es2 ;
		...
		$this->excel->getActiveSheet(1)->setCellValue('B2', 'NIP');		
		$this->excel->getActiveSheet(1)->setCellValue('C2', 'Nama');		
		// $this->excel->getActiveSheet(1)->setCellValue('D2', 'Nilai ');
		// $this->excel->getActiveSheet(1)->setCellValue('E2', 'Eselon II');
		// $this->excel->getActiveSheet(1)->setCellValue('F2', 'Jabatan');
		// $this->excel->getActiveSheet(1)->setCellValue('G2', 'Atasan Langsung');		
		// $this->excel->getActiveSheet(1)->setCellValue('H2', 'Belum Diperiksa');
