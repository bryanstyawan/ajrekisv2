...
class Admin extends CI_Controller 
{
	...
	public function change_password()
	{
		...
		$data['history_golongan']   = $this->Madmin->get_history_golongan();
		$data['history_jabatan']  	= $this->Madmin->get_history_jabatan();
		$data['history_pendidikan'] = $this->Madmin->get_history_pendidikan();
		$data['diklat_struktural'] 	= $this->Madmin->get_history_diklat('1');
		$data['diklat_fungsional'] 	= $this->Madmin->get_history_diklat('2');
		$data['diklat_teknis'] 		= $this->Madmin->get_history_diklat('3');
