...
class Mlogin extends CI_Model {
	...
	public function getPeminatan($id)
	{
		# code...
		// print_r($this->session->userdata());die();
        $query = "SELECT a.* 
		FROM survey2_peminatan a
	...
	public function getAnswerRumpun($id)
	{
		...
		// print_r($this->session->userdata());die();
        $query = "SELECT a.* 
		FROM survey2_rumpun a
		WHERE a.id_pegawai = '".$id."'";
        return $this->db->query($query);		
	}

	public function getAnswerNPS($id)
	{
		# code...
        $query = "SELECT a.* 
		FROM survey2_nps a
	...
	public function getAnswerEngagement($id)
	{
		# code...
        $query = "SELECT a.* 
		FROM survey2_engagement a
		WHERE a.id_pegawai = '".$id."'";
        return $this->db->query($query);		
	}	
