                ...
                <div class="box">
                    <div class="box-body" >
                        ...
                        <div class="col-lg-12">
                            ...
                            ?>
                                            <div class="col-lg-2">
                                                <input class="form-check-input" type="radio" name="exampleRadios_<?=$value1->id_pertanyaan;?>" id="exampleRadios1_<?=$value1->id_pertanyaan;?>" value="1" onclick="selectRadio('<?=$value1->id_pertanyaan;?>')" <?=($value1->jawaban == 1)? 'checked' : '';?>>
                                                <label class="form-check-label" for="exampleRadios_<?=$value1->id_pertanyaan;?>">
                                                Tidak setuju
                                                </label>
                                            </div>
                                            <div class="col-lg-2">
                                                <input class="form-check-input" type="radio" name="exampleRadios_<?=$value1->id_pertanyaan;?>" id="exampleRadios2_<?=$value1->id_pertanyaan;?>" value="2" onclick="selectRadio('<?=$value1->id_pertanyaan;?>')" <?=($value1->jawaban == 2)? 'checked' : '';?>>
                                                <label class="form-check-label" for="exampleRadios_<?=$value1->id_pertanyaan;?>">
                                                Kurang setuju
                                                </label>
                                            </div>
                                            <div class="col-lg-2">
                                                <input class="form-check-input" type="radio" name="exampleRadios_<?=$value1->id_pertanyaan;?>" id="exampleRadios3_<?=$value1->id_pertanyaan;?>" value="3" onclick="selectRadio('<?=$value1->id_pertanyaan;?>')" <?=($value1->jawaban == 3)? 'checked' : '';?>>
                                                <label class="form-check-label" for="exampleRadios_<?=$value1->id_pertanyaan;?>">
                                                Setuju
                                                </label>
                                            </div>
                                            <div class="col-lg-2">
                                                <input class="form-check-input" type="radio" name="exampleRadios_<?=$value1->id_pertanyaan;?>" id="exampleRadios3_<?=$value1->id_pertanyaan;?>" value="4" onclick="selectRadio('<?=$value1->id_pertanyaan;?>')" <?=($value1->jawaban == 4)? 'checked' : '';?>>
                                                <label class="form-check-label" for="exampleRadios_<?=$value1->id_pertanyaan;?>">
                                                Sangat setuju
                                                </label>
                                            </div>                                                                                                                                    
